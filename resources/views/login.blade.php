...
<form class="flex-md-column align-items-center bg-info p-3 w-50 m-auto shad" method="post" action="login" style="display: flex; flex-direction: column; gap: 6px; width: 100%;">
    @csrf
    <div>
        <div>Email</div>
